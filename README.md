...
1. I think it would have been cool to have different chat rooms
2. I think implementing likes on message/replies could be useful as well.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

![chat_gif](https://user-images.githubusercontent.com/22280621/46328367-8169e080-c5cc-11e8-81bc-fea36386125b.gif)

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

The main challenge I had when building this app was making sure I had all my outlets connected correctly. Sometime I would run into issues where I forgot to add or remove an outlet. 
